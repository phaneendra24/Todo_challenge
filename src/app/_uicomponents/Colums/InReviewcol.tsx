      ...
      <div className="flex flex-col gap-[20px]">
        ...
        <div className="flex flex-col gap-[10px] h-full">
          {data?.filter(i => i.status == "IN_REVIEW").map((i) => {
            return (
              <TaskContainer i={i} key={i.id} color="#3FA1E3" bg="#EFF8FF" settrigger={settrigger} />
